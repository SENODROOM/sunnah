...
export interface NasaiData { metadata: Metadata; chapters: Chapter[]; hadiths: Hadith[]; }
export interface NasaiInstance extends ArrayLike<Hadith> {
  [index: number]: Hadith;
...
export declare class Nasai { constructor(data: NasaiData); }
export declare function loadNasai(): Promise<NasaiInstance>;
declare const nasai: NasaiInstance;
